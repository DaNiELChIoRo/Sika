...
public class StatesRequest extends WebClient.RequestInterface{

    private static final String TAG = StatesRequest.class.getSimpleName();

    private int idCountry;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public StatesRequest(int idCountry, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_STATES, idCountry);
    }
