...
public class SolutionRequest extends WebClient.RequestInterface{

    private static final String TAG = SolutionRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public SolutionRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
