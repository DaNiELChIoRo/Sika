...
public class TaxonomyRequest extends WebClient.RequestInterface{

    private static final String TAG = TaxonomyRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public TaxonomyRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
