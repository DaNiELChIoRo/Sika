...
public class StoresByProductIdRequest extends WebClient.RequestInterface{

    private static final String TAG = StoresByProductIdRequest.class.getSimpleName();
    ...
    public StoresByProductIdRequest(int idProduct, UserLocation mUserLocation, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_STORES_BY_PRODUCT_ID, idProduct)
                + "?lat=" + mUserLocation.getLatitude() + "&lng=" + mUserLocation.getLongitude()
                + "&metres=" + MyApplication.getAppContext().getString(R.string.meters);
    }
