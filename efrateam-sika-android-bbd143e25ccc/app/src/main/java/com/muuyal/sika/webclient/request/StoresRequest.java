...
public class StoresRequest extends WebClient.RequestInterface{

    private static final String TAG = StoresRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public StoresRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
