...
public class NearestStoresRequest extends WebClient.RequestInterface{

    private static final String TAG = NearestStoresRequest.class.getSimpleName();

    private UserLocation mUserLocation;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public NearestStoresRequest(UserLocation mUserLocation, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return API.URL_STORES_NEAREST + "?lat=" + mUserLocation.getLatitude() + "&lng=" + mUserLocation.getLongitude();
    }
