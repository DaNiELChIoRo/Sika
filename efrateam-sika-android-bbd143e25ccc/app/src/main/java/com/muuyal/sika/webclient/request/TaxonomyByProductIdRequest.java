...
public class TaxonomyByProductIdRequest extends WebClient.RequestInterface{

    private static final String TAG = TaxonomyByProductIdRequest.class.getSimpleName();

    private int idProduct;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public TaxonomyByProductIdRequest(int idProduct, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_TAXONOMY_BY_PRODUCT_ID, idProduct);
    }
