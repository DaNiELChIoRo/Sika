...
public class DistrictsRequest extends WebClient.RequestInterface{

    private static final String TAG = DistrictsRequest.class.getSimpleName();

    private int idState;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public DistrictsRequest(int idState, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_DISTRICTS, idState);
    }
