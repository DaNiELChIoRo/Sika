...
public class ProductsRequest extends WebClient.RequestInterface{
    ...
    public ProductsRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
