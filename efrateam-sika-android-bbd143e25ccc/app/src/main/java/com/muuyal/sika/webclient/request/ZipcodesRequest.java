...
public class ZipcodesRequest extends WebClient.RequestInterface{

    private static final String TAG = ZipcodesRequest.class.getSimpleName();

    private int idState;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public ZipcodesRequest(int idState, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_ZIPCODES, idState);
    }
