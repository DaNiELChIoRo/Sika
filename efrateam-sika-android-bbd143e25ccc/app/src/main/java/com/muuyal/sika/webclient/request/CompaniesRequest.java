...
public class CompaniesRequest extends WebClient.RequestInterface{

    private static final String TAG = CompaniesRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public CompaniesRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
