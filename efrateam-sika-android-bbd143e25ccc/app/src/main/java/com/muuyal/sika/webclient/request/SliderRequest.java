...
public class SliderRequest extends WebClient.RequestInterface{

    public static final String TAG = SliderRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public SliderRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
