...
public class GlossaryRequest extends WebClient.RequestInterface{

    private static final String TAG = GlossaryRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public GlossaryRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
