...
public class ProductsByTaxonomyIdRequest extends WebClient.RequestInterface{

    private static final String TAG = ProductsByTaxonomyIdRequest.class.getSimpleName();

    private int idTaxonomy;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public ProductsByTaxonomyIdRequest(int idTaxonomy, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_PRODUCTS_BY_TAXONOMY_ID, idTaxonomy);
    }
