...
public class ProductsRelatedRequest extends WebClient.RequestInterface{

    private static final String TAG = ProductsRelatedRequest.class.getSimpleName();

    private int idProduct;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public ProductsRelatedRequest(int idProduct, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_PRODUCTS_RELATED, idProduct);
    }
