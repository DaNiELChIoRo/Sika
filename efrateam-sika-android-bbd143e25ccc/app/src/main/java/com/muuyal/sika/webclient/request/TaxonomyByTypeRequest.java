...
public class TaxonomyByTypeRequest extends WebClient.RequestInterface{

    private static final String TAG = TaxonomyByTypeRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public TaxonomyByTypeRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return API.URL_TAXONOMY_BY_TYPE;
    }
