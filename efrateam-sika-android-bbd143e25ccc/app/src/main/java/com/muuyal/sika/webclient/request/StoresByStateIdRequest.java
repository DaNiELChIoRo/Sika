...
public class StoresByStateIdRequest extends WebClient.RequestInterface{

    private static final String TAG = StoresByStateIdRequest.class.getSimpleName();

    private int idState;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public StoresByStateIdRequest(int idState, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return String.format(API.URL_STORES_BY_STATE_ID, idState);
    }
