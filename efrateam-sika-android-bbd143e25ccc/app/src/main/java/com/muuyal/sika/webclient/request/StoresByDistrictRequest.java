...
public class StoresByDistrictRequest extends WebClient.RequestInterface{

    private static final String TAG = StoresByDistrictRequest.class.getSimpleName();

    private String mDistrict;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public StoresByDistrictRequest(String mDistrict, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return API.URL_STORES_BY_DISTRICT + mDistrict + "&paginate=disabled";
    }
