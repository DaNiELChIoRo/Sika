...
public class SuggestionsRequest extends WebClient.RequestInterface{

    public static final String TAG = SuggestionsRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public SuggestionsRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
