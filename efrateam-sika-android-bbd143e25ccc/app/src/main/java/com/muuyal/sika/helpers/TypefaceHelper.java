...
import com.muuyal.sika.customs.CustomTypefaceSpan;
...
public class TypefaceHelper {
    ...
    //Defined fonts
    public static final String FONT_OPEN_SANS = "open_sans";
    ...
    public static synchronized void initialize(Context context, int xmlResource) {
        if (INSTANCE == null) {
            INSTANCE = new TypefaceHelper(context, xmlResource);
        }
     ...
     */
    private TypefaceHelper(Context context, int xmlResource) {
    ...
    public static void applyFont(Button target, AttributeSet attrs, int defStyle) {
        if (target == null || target.isInEditMode()) {
            return;
        }
        ExtraFontData data = getFontData(target);
     ...
     * Typeface for menus
     *
     * @param m is the menu to change typeface
     * @param font is the Typeface to setup
     * ***/
    public static void applyFontToMenu(Menu m, Typeface font) {
        if (m == null || font == null)
            return;
     ...
     * Typeface for menus
     *
     * @param mi is the menu Item to change typeface
     * @param font is the Typeface to setup
     * ***/
