...
public class CountriesRequest extends WebClient.RequestInterface{

    private static final String TAG = CountriesRequest.class.getSimpleName();

    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public CountriesRequest(LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
