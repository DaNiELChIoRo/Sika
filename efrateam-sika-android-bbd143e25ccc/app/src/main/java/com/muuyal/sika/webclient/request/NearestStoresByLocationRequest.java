...
public class NearestStoresByLocationRequest extends WebClient.RequestInterface{

    private static final String TAG = NearestStoresByLocationRequest.class.getSimpleName();

    private UserLocation mUserLocation;
    private WebClient.WebClientListener listener;
    private LinkedHashMap<String, String> params;

    public NearestStoresByLocationRequest(UserLocation mUserLocation, LinkedHashMap<String, String> params, WebClient.WebClientListener listener) {
    ...
    public String getUrl() {
        return API.URL_STORES_NEAREST + "?latitude=" + mUserLocation.getLatitude() + "&longitude=" + mUserLocation.getLongitude();// + "&metres=10000";
    }
